...
export const siteConfig: SiteConfig = {
	title: "ChaoNous Blog",
	subtitle: "",
	siteURL: "https://chaonous.com/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-03-03", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	toc: {
		...
		useJapaneseBadge: false, // 使用日语假名标记（アオイウエオ...）代替数字
	},
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://meting.liuxiaohan.cn/?server=:server&type=:type&id=:id&auth=:auth&r=:r", // Meting API 地址
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to ChaoNous Blog!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
		...
		link: "https://github.com/ChaoNous/ChaoNous-Blog", // 关于链接
	},
};
