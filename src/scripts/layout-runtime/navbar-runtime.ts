...
export function syncNavbarVisibility(scrollTop: number, bannerEnabled: boolean) {
...
export function handleNavbarLinkClick(scrollTop: number, bannerEnabled: boolean) {
	if (!bannerEnabled) return;
