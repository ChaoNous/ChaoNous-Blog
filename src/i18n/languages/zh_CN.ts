...
export const zh_CN: Translation = {
  ...
  [Key.diarySubtitle]: "随时随地，记录生活",
  [Key.diaryCount]: "条记录",
  [Key.diaryReply]: "回复",
  [Key.diaryTips]: "仅显示最近 30 条记录",
  ...
  [Key.devices]: "我的设备",
  [Key.devicesSubtitle]: "这里展示我日常使用的设备",
  [Key.devicesViewDetails]: "查看详情",

  [Key.projects]: "项目",
  [Key.projectsSubtitle]: "我的项目与作品",
  [Key.projectsAll]: "全部",
  ...
  [Key.projectsVisit]: "前往项目",
  [Key.projectsGitHub]: "GitHub",

  [Key.skills]: "技能",
  [Key.skillsSubtitle]: "我的技术栈与能力分布",
  ...
  [Key.skillsAdvancedTitle]: "核心技能",
  [Key.skillsProjects]: "相关项目",
  [Key.skillsDistribution]: "技能分布",
  [Key.skillsByLevel]: "按等级",
  [Key.skillsByCategory]: "按分类",
  [Key.noData]: "暂无数据",

  [Key.timeline]: "时间线",
  [Key.timelineSubtitle]: "我的经历与重要节点",
  ...
  [Key.passwordProtectedDescription]: "请输入密码以查看受保护内容",
  ...
  [Key.rssSubtitle]: "通过 RSS 订阅，第一时间获取最新文章与动态",
  [Key.rssLink]: "RSS 链接",
  ...
  [Key.rssWhatIsRSSDescription]:
    "RSS 是一种用于发布频繁更新内容的订阅格式。通过 RSS，你可以：",
  [Key.rssBenefit1]: "及时获取网站最新内容，无需手动访问",
  [Key.rssBenefit2]: "在一个地方集中管理多个网站订阅",
  [Key.rssBenefit3]: "避免错过重要更新和文章",
  [Key.rssBenefit4]: "享受更纯净的阅读体验",
  ...
  [Key.atomSubtitle]: "通过 Atom 订阅，第一时间获取最新文章与动态",
  ...
  [Key.atomWhatIsAtomDescription]:
    "Atom 是一种基于 XML 的订阅格式，用于描述订阅源及其条目。通过 Atom，你可以：",
  [Key.atomBenefit1]: "及时获取网站最新内容，无需手动访问",
  [Key.atomBenefit2]: "在一个地方集中管理多个网站订阅",
  [Key.atomBenefit3]: "避免错过重要更新和文章",
  [Key.atomBenefit4]: "享受更纯净的阅读体验",
