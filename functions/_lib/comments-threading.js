/**
 * @typedef {import("./comments-types").NormalizedComment} NormalizedComment
 * @typedef {import("./comments-types").NestedComment} NestedComment
 */
...
/**
 * @param {NormalizedComment} left
 * @param {NormalizedComment} right
 */
...
/**
 * Build nested comment threads while preserving chronological order.
 *
 * @param {NormalizedComment[]} records
 * @returns {NestedComment[]}
 */
...
/**
 * Paginate comment threads by root comment so replies never get split away
 * from their parent thread.
 *
 * @param {NormalizedComment[]} records
 * @param {number} page
 * @param {number} limit
 * @returns {{ data: NestedComment[]; totalCount: number }}
 */
